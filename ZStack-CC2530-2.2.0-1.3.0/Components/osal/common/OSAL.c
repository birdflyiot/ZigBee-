...
void UartSend_String1(char *Data,int len);
void delay2(int xms);
void Delay1(int i);
...
void osal_start_system( void )
{
  ...
  UartSend_String1(Txdata,46); //串口发送数据 
  
//  strcpy(Txdata,"AT+CIPSTART=\"TCP\",\"15054b3b.nat123.net\",11780\r\n");     //将发送内容copy到Txdata;
//  UartSend_String1(Txdata,47); //串口发送数据 
